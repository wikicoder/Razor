...
#line hidden
            ...
            __tagHelperExecutionContext.Add(__InputTagHelper2);
            if (__InputTagHelper1.IntDictionaryProperty == null) {
                throw new InvalidOperationException(FormatInvalidIndexerAssignment("int-prefix-grabber", "InputTagHelper1", "IntDictionaryProperty"));
            }
            if (__InputTagHelper1.StringDictionaryProperty == null) {
                throw new InvalidOperationException(FormatInvalidIndexerAssignment("string-prefix-grabber", "InputTagHelper1", "StringDictionaryProperty"));
            }
